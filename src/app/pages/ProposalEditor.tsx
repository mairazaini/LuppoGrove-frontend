    ...
    fields: [
      {
        ...
        type: "text",
        placeholder: "Enter a concise project title...",
        value: "Customer Sentiment Analysis Tool",
      },
      {
        id: "goals",
        sectionNumber: 2,
        ...
        placeholder: "Describe the project goals and company benefits...",
        value:
          "Build a real-time customer sentiment analysis pipeline that processes social media mentions, support tickets, and product reviews. Students will design NLP models capable of classifying sentiment polarity and detecting emerging themes across multiple data sources.\n\nExpected benefits include 40% faster identification of negative sentiment spikes, automated weekly brand-health reports, and a reusable NLP pipeline deployable on internal infrastructure.",
      },
      {
        id: "nda",
        sectionNumber: 3,
      ...
      },
      {
        ...
        placeholder: "List expected deliverables...",
        value:
          "• Sentiment classification model with ≥80% F1 score\n• Data ingestion pipeline for Twitter API and Zendesk\n• Interactive dashboard for brand health monitoring\n• Technical documentation and deployment runbook",
      },
      {
        id: "team",
        sectionNumber: 5,
        ...
        type: "text",
        placeholder: "e.g. 4-5 students...",
        value: "Small team (3-4 students) with NLP and Python experience",
      },
      {
        id: "timeline",
        sectionNumber: 6,
        ...
        value: "8 Weeks — Fall Semester 2026",
      },
    ],
  },
  "5": {
    course: "Digital Service Design",
    ...
    fields: [
      {
        ...
        type: "text",
        placeholder: "Enter a concise project title...",
        value: "IoT Device Fleet Management Platform",
        aiGenerated: true,
        hint: "The AI generated this from your conversation. Feel free to refine it.",
      },
      {
        ...
        placeholder: "Describe the project goals and company benefits...",
        value:
          "Design and implement a centralized platform for managing a fleet of 500+ IoT sensor devices deployed across industrial facilities. The system will provide real-time device health monitoring, remote firmware update capabilities, and automated alerting for connectivity anomalies.\n\nExpected benefits include 70% reduction in manual device audits, centralized firmware rollout across device cohorts, and a scalable architecture supporting future fleet expansion to 5,000+ devices.",
        aiGenerated: true,
      },
      {
        id: "nda",
        ...
        type: "dropdown",
        placeholder: "Select NDA requirement...",
        value: "Custom Company NDA Required",
        options: [
          "No NDA Required",
          "Standard LUT NDA Required",
          "Custom Company NDA Required",
        ...
        hint: "A custom NDA is required due to proprietary IoT protocol specifications.",
      },
      {
        id: "scope",
        sectionNumber: 4,
        ...
        placeholder: "List expected deliverables...",
        value:
          "• Device registry and health monitoring dashboard (React + MQTT)\n• OTA firmware update service with rollback capability\n• Automated alerting system for offline/degraded devices\n• REST API for third-party integrations\n• Load testing report for 500-device simulation",
        aiGenerated: true,
      },
      {
        id: "team",
        ...
        type: "text",
        placeholder: "e.g. 4-5 students...",
        value: "Medium team (5-6 students) with IoT and cloud infrastructure experience",
        aiGenerated: true,
      },
      {
        id: "timeline",
        ...
        value: "16 Weeks — Fall Semester 2026",
        aiGenerated: true,
      },
    ],
  },

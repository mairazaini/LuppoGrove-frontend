...
export function AaltoCourseDetails() {
      ...
      <main className="ml-[280px] flex-1">
        ...
        <div className="px-12 pt-12 pb-6 bg-[#fafaf9]">
          ...
          <div className="text-sm text-gray-500 mb-4">
            ...
            {" / "}
            <span className="text-gray-700">CS-C3170</span>
          </div>

          {/* Title */}
          <h1 className="text-4xl font-bold text-gray-900 mb-4">
            CS-C3170 Software Engineering: Web & Cloud Technologies
          </h1>
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-gray-700">Coordinator: Prof. Casper L.</span>
            </div>
        ...
        <div className="px-12 py-6 bg-[#fafaf9]">
          <div 
            className="w-full h-[300px] rounded-[20px] bg-gradient-to-br from-[#667eea] to-[#764ba2] flex items-center justify-center overflow-hidden relative"
          >
            {/* Abstract pattern for cloud/web technologies */}
            <div className="absolute inset-0">
              <div className="absolute top-1/4 left-1/4 w-40 h-40 rounded-full bg-white/10" />
              <div className="absolute bottom-1/3 right-1/4 w-32 h-32 bg-white/15" style={{ clipPath: 'polygon(50% 0%, 100% 50%, 50% 100%, 0% 50%)' }} />
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p className="text-gray-700 leading-relaxed">
                This course focuses on modern software engineering practices for building scalable web applications and cloud-native systems. Students work on industry-relevant projects to gain hands-on experience with contemporary development frameworks, containerization, CI/CD pipelines, and cloud deployment strategies. The curriculum emphasizes both technical excellence and collaborative development methodologies.
              </p>
            </section>
            ...
            <section>
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600">
                      React, Node.js, Docker, and cloud platforms (AWS/Azure/GCP) for production-ready applications.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Cloud Deployment</h3>
                    <p className="text-sm text-gray-600">
                      Students deploy their projects to production environments with proper DevOps practices.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">3-Week Iterations</h3>
                    <p className="text-sm text-gray-600">
                      Flexible sprint cycles that accommodate academic schedules while maintaining momentum.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-gray-900 mb-1">Bi-weekly Reviews</h3>
                    <p className="text-sm text-gray-600">
                      Regular check-ins to review technical progress and adjust project scope as needed.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
                ...
                <ul className="space-y-3 ml-8">
                  <li className="text-gray-700 text-sm">
                    <strong>Sign Aalto NDA (if applicable):</strong> Required only for projects involving proprietary data or trade secrets.
                  </li>
                  <li className="text-gray-700 text-sm">
                    <strong>Provide technical mentorship:</strong> A senior developer or architect who can guide architectural decisions.
                  </li>
                  <li className="text-gray-700 text-sm">
                    <strong>Cloud infrastructure access:</strong> If needed, provide sandbox environments or test accounts for deployment.
                  </li>
                  <li className="text-gray-700 text-sm">
                    <strong>Code review participation:</strong> Participate in at least 2-3 code reviews throughout the semester to ensure quality.
                  </li>
                </ul>
              </div>
            </section>
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-2">
                    Looking for web & cloud projects
                  </h3>
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 mt-1">
                    ...
                    <span>~12 hours/week per student</span>
                  </div>
                </div>
